 ...
 * @author minhv
 */
@WebServlet(name = "LoadCreateQuestionPage", urlPatterns = {"/LoadCreateQuestionPage"})
public class LoadCreateQuestionPage extends HttpServlet {
    
    private final String CREATE_QUESTION_PAGE = "create-question-page";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadCreateQuestionPage _ SQLException: " + e.getMessage());
        } catch (NamingException e) {
            log("LoadCreateQuestionPage _ NamingException: " + e.getMessage());
        } finally {
