 ...
 * @author minhv
 */
@WebServlet(name = "LoadStudentPageServlet", urlPatterns = {"/LoadStudentPageServlet"})
public class LoadStudentPageServlet extends HttpServlet {

    private final String LOAD_STUDENT_PAGE_SERVLET = "student-page";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = LOAD_STUDENT_PAGE_SERVLET;
        try {
            //load subject list
            ...
            log("LoadStudentPageServlet _ SQLException: " + e.getMessage());
        } catch (NamingException e) {
            log("LoadStudentPageServlet _ NamingException: " + e.getMessage());
        }  finally {
