    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                quizDAO.searchQuiz(email, cmbSubject, cmbTimeTakeQuiz);
            ...
            log("SearchQuizServlet _ SQLException: " + e.getMessage());
        } catch (NamingException e) {
            log("SearchQuizServlet _ NamingException: " + e.getMessage());
        } finally {
